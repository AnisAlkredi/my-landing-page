...
export default function ContactForm({ t }: { t: any }) {
  ...
  const fadeHighlight = {
    ...
    whileHover: { scale: 1.02, boxShadow: '0 0 0 3px #a3e635' }
  };

  return (
    <motion.section
      id="contact"
      className="bg-white dark:bg-[#111827] border dark:border-lime-400/20 p-8 rounded-xl shadow-xl space-y-6 text-center mt-32"
      {...fadeHighlight}
    >
