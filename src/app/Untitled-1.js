  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="description"
          content="Anis Alkredi – Webentwicklung, Automatisierung und KI-Lösungen aus Süddeutschland. Persönlich. Modern. Schnell."
        />
      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-28 md:space-y-32">
        ...
        <motion.section
          id="contact"
          className="bg-white dark:bg-[#111827] border dark:border-lime-400/20 p-8 rounded-xl shadow-xl space-y-6 text-center"
          {...fadeUp}
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
            ...
            <button
              onClick={() =>
                alert(lang === "de" ? "Nachricht gesendet!" : "Message sent!")
              }
        ...
        <section
          id="impressum"
          className="text-sm text-gray-600 dark:text-gray-300 max-w-2xl mx-auto pt-20 px-4"
        >
        ...
        <section
          id="datenschutz"
          className="text-sm text-gray-600 dark:text-gray-300 max-w-2xl mx-auto pt-12 pb-24 px-4"
        >
          <h2 className="text-lg font-bold mb-2">Datenschutzerklärung</h2>
          <p>
            Der Schutz Ihrer persönlichen Daten ist uns ein besonderes Anliegen.
            Diese Website speichert keine personenbezogenen Daten ohne Ihre
            ausdrückliche Zustimmung. Beim Ausfüllen des Kontaktformulars werden
            Ihre Angaben zur Bearbeitung Ihrer Anfrage gespeichert und an die im
            Impressum genannte E-Mail-Adresse übermittelt. Es erfolgt keine
            Weitergabe an Dritte. <br />
            <br />
            Ihre Rechte gemäß DSGVO (Auskunft, Berichtigung, Löschung,
            Einschränkung, Datenübertragbarkeit und Widerspruch) bleiben
            unberührt. Sie erreichen uns unter den im Impressum angegebenen
            Kontaktdaten.
          </p>
        </section>
      </div>
