    ...
    <div className="space-x-4">
      ...
      >
        <motion.div className="group bg-white dark:bg-[#111827] border dark:border-lime-400/20 p-6 rounded-xl shadow-md hover:shadow-2xl hover:ring-2 hover:ring-lime-400 transition-all duration-300 space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: t.impressumContent }} />
        </motion.div>
      </motion.section>
      ...
      >
        <motion.div className="group bg-white dark:bg-[#111827] border dark:border-lime-400/20 p-6 rounded-xl shadow-md hover:shadow-2xl hover:ring-2 hover:ring-lime-400 transition-all duration-300 space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: t.privacyContent }} />
        </motion.div>
      </motion.section>
    </main></>);
}
